...
#--noconsole
data_files = "--add-data logo_icon.ico;. --add-data \"matrix code nfi.ttf\";." # " --add-data logo_icon.ico;. --add-data rc;rc --add-data mgmt.version;. " + \
    #" --add-data install_service.cmd;. "
hidden_imports = "" # "--hidden-import sip --hidden-import win32timezone"
build_params = "python -m PyInstaller --onefile --noconsole " + clean + \
    hidden_imports + \
    " --noupx " + \
